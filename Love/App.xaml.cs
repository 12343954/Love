...
namespace Love
{
    public partial class App : Application
    {
        ...
        public static CookieContainer g_CookieContainer { get; set; }
        public static string MyID { get; set; } //我的网易ID
        public static string Search { get; set; } //搜索条件
        public static JObject MyLove { get; set; } //我的花田登录信息
        public static Love.Model.User UserVisit { get; set; } //被访问的user对象，在头像点击时赋值，在ME.xaml使用
        public static string MyHomeHTML { get; set; }   //登录后的首页html，用于检索用户名
        ...
        public App()
        {
            ...
            //g_CookieContainer = new CookieContainer();
            PhoneApplicationService.Current.State["G_Cookies"] = null;
        }
