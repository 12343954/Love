...
namespace DotNet.Utilities
{
    ...
    public class HttpHelper
    {
        ...
        //Post数据编码
        private Encoding postencoding = Encoding.Unicode;
        ...
        public HttpResult GetHtml(HttpItem objhttpitem)
        {
            ...
            try
            {
                ...
                using (response = (HttpWebResponse)request.EndGetResponse(null))
                {
                    ...
                    //得到返回的HTML
                    result.Html = encoding.GetString(RawResponse, 0, RawResponse.Length);
                }
                #endregion
            }
        ...
        private void SetRequest(HttpItem objhttpItem)
        {
            ...
            if (objhttpItem.Header != null && objhttpItem.Header.Count > 0)
                ...
                {
                    request.Headers[item] = objhttpItem.Header[item];
                }
            // 设置代理
        ...
        private void SetCookie(HttpItem objhttpItem)
        {
            ...
            if (objhttpItem.CookieCollection != null)
            {
                ...
                request.CookieContainer.Add(new Uri(objhttpItem.URL), objhttpItem.CookieCollection);
            }
        }
        /// <summary>
        /// 设置Post数据
        ...
        private void SetPostData(HttpItem objhttpItem)
        {
            ...
            if (request.Method.Trim().ToLower().Contains("post"))
            {
                ...
                if (buffer != null)
                {
                    ...
                    request.EndGetRequestStream(null).Write(buffer, 0, buffer.Length);
                }
            }
        }
        /// <summary>
